...
@CucumberOptions(strict = true,
        features = "src/test/java/com/example/selenium/tests/cucumber/features/webelements/checkbox/gherkins/checkboxByText.feature",
        glue = "com.example.selenium.tests.cucumber.features.webelements.checkbox.stepdefs",
        plugin = "json:target/report/webelements/checkbox/checkboxByText.json")
public class CheckBoxByTextTest extends BaseTest {
