package com.capgemini.ntc.selenium.tests.cucumber.features.registration.runners;
...
@CucumberOptions(strict = true,
			...
			glue = "com.capgemini.ntc.selenium.tests.cucumber.features.registration.stepdefs",
