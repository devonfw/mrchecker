...
@CucumberOptions( strict = true,
                features = "src/test/java/com/example/selenium/tests/cucumber/features/webelements/dropdownlist/gherkins/dropdownByText.feature",
        glue = "com.capgemini.ntc.selenium.tests.cucumber.features.webelements.dropdownlist.stepdefs",
                plugin = "json:target/report/webelements/dropdownlistByText.json")
public class DropdownByTextTest extends BaseTest {
