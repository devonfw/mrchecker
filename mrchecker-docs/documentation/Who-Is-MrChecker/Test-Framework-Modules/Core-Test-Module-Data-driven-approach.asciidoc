...
Data driven approach is a way of making decisions based on collected data. Using this strategy makes it easier to stay objective and get measureable outcomes.
