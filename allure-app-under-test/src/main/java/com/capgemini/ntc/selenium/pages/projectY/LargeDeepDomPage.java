...
public class LargeDeepDomPage extends BasePage {
	...
	private final static By		mainHeaderLocator			= By.xpath("//div[@class='example']/h3");
	private final static By		noSiblingsHeaderLocator		= By.xpath("//div[@class='example']/h4[1]");
	private final static By		siblingsHeaderLocator		= By.xpath("//div[@class='example']/h4[2]");
	private final static By		descriptionParagraphLocator	= By.xpath("//div[@class='example']/p[1]");
	private final static By		noSiblingsParagraphLocator	= By.id("no-siblings");
	private final static By		siblingsDivLocator			= By.id("no-siblings");
	private final static By		largeTableLocator			= By.id("large-table");
	...
	private final static List<WebElement>	siblings	= new ArrayList<>();
	private final static List<WebElement>	headerCells	= new ArrayList<>(EXP_TBL_HDR_CELLS_CNT);
	private final static List<WebElement>	tableRows	= new ArrayList<>(EXP_TBL_HDR_CELLS_CNT);
