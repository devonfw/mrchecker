...
public class NestedFramesPage extends BasePage {
	...
	private final static By	topFrameLocalizer		= By.name(Frame.TOP.getName());
	private final static By	leftFrameLocalizer		= By.name(Frame.LEFT.getName());
	private final static By	middleFrameLocalizer	= By.name(Frame.MIDDLE.getName());
	private final static By	rightFrameLocalizer		= By.name(Frame.RIGHT.getName());
	private final static By	bottomFrameLocalizer	= By.name(Frame.BOTTOM.getName());
