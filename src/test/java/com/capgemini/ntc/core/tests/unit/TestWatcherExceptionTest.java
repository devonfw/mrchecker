...
import com.capgemini.ntc.exceptions.BFInputDataException;
...
public class TestWatcherExceptionTest {
	...
	public void testMethodExceptionTest() {
		...
		assertNotNull("There was no exception thrown in test", thrownException);
		assertNotNull(
				"Object is null - program didn't run further after exception what implicate test watcher logic was rebuild",
				object);
	}
	...
	public static class SetUpExceptionTest extends BaseTest {
		...
		@Override
		public void setUp() {
			BFLogger.logInfo(this.getClass().getCanonicalName() + " -> setUp()");
			throw new BFInputDataException("Text exception");
		}
	...
	public static class TestMethodExceptionTest extends BaseTest {
		...
		@Test
		public void testMethod() {
			BFLogger.logInfo(this.getClass().getCanonicalName() + " -> testMethod()");
			throw new BFInputDataException("Text exception");
		}
	...
	public static class TearDownExceptionTest extends BaseTest {
		...
		@Override
		public void tearDown() {
			BFLogger.logInfo(this.getClass().getCanonicalName() + " -> tearDown()");
			throw new BFInputDataException("Text exception");
		}
