...
public class RegistrationPage extends BasePage {
	...
	public void setHobby(com.example.selenium.pages.features.registration.Hobby hobby) {
		getDriver().elementCheckbox(selectorHobby).setCheckBoxByValue(hobby.toString());
	}

	public void setHobby(com.example.selenium.pages.features.registration.Hobby[] hobbies) {
		com.example.selenium.pages.features.registration.Hobby hobby;
