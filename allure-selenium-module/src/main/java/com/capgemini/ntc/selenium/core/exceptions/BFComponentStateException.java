...
public class BFComponentStateException extends AssertionError {
	 ...
	 * action.
	 * 
	 * Example: User has to to click on a Button, but nothing happens, button is disabled. Calling
	 * "throw new BFComponentStateException("Button", "click", "disabled")" is going to create error message:
	 * "Unable to [click] [Button]. Component is [disabled]."
	 * 
	 * @param componentName
	 * @param action
	 * @param actualState
