...
public class TestUtils {
	...
	public static boolean isCurrentUrlContains(String url) {
		if (BasePage.getDriver().getCurrentUrl().contains(url)) {
			...
			BFLogger.logDebug("Not on " + url + " page. Current page: " + BasePage.getDriver().getCurrentUrl());
			return false;
		}
	}
	...
	public static boolean isCurrentPageTitle(String title) {
		if (BasePage.getDriver().getTitle().contains(title)) {
			...
			BFLogger.logDebug("Not on " + title + " page. Current page: " + BasePage.getDriver().getTitle());
			return false;
		}
	}
	...
	public boolean isTextOnPage(String text) {
		return BasePage.getDriver().findElement(By.cssSelector("body")).getText().contains(text);
	}
