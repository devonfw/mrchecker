...
public final class NewFirefoxDriver extends FirefoxDriver implements INewWebDriver {
	...
	/**
	 * Try to find element quietly - NoSuchElementException will not be thrown.
	 * Use it to check if element exist on page e.g. PopUp
	 * 
	...
	/**
	 * Try to find by dynamic element - will wait given by user an amount of
	 * seconds for an element to load on page. If element will not be found will
	 * throw an exception (PiAtElementNotLoadedException)
	 * 
	 * @param by
	 *            selector
	 * @param timeout
	...
	/**
	 * Try to find by dynamic List of elements - will wait given by user an
	 * amount of seconds for an element to load on page. If element will not be
	 * found will throw an exception (PiAtElementNotLoadedException)
	 * 
	 * @param by
	 *            selector
	 * @param timeout
	...
	/**
	 * Try to find by dynamic List of elements - will wait
	 * {@link BasePage.EXPLICITYWAITTIMER} seconds for an element to load on
	 * page. If element will not be found will throw an exception
	 * (PiAtElementNotLoadedException)
	 * 
	 * @param by
	 *            selector
	 * @return found WebElement object
