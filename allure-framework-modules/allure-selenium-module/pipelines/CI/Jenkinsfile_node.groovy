node(){
	...
	properties([
		parameters([
			string(defaultValue: 'allure-framework-modules/allure-selenium-module/', description: 'Execute job for given Module. Example allure-framework-modules/allure-selenium-module/ ', name: 'APP_WORKSPACE'),
