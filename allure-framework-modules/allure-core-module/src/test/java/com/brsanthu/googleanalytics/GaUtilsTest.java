...
public class GaUtilsTest {
	...
	public void testAppendSystemProperty() throws Exception {
		...
		assertEquals("", GaUtils.appendSystemProperty(new StringBuilder(), "nonexistent")
				.toString());
		assertEquals("test", GaUtils.appendSystemProperty(new StringBuilder(), "test")
				.toString());
		assertEquals("foo/test", GaUtils.appendSystemProperty(new StringBuilder("foo"), "test")
				.toString());
	}
}
