...
public class NumberUtils {
  ...
  /**
   * Removes '$' and ',' marks from passed textValue and convert to BigDecimal object Warning if given textValue is null
   * or empty return 0
   * 
   * @param textValue
   * @return BigDecimal object with 2 decimal points precision
  ...
  /**
   * Tells if difference between two BigDecimal values is major, e.g. between balance of group of account received from
   * page and second value received from summing it sub-accounts Warning: Check if accepted difference factor meets
   * requirements
   * 
   * @param oneValue
   *          - comparised value
  ...
  /**
   * This function returns a pseudorandom, uniformly distributed int value between 0 (inclusive) and the specified value
   * (exclusive) - <0, seed)
   * 
   * @param seed
