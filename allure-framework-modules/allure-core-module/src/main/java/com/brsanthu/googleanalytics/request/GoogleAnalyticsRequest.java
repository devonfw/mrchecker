...
public class GoogleAnalyticsRequest<T> {
	 ...
	 * Example usage: <code>ds=web</code> Example value: <code>app</code><br>
	 * Example usage: <code>ds=app</code> Example value: <code>call center</code><br>
	 * Example usage: <code>ds=call%20center</code> Example value: <code>crm</code><br>
	 ...
	 * Example usage: <code>uid=as8eknlll</code> </div> </div>
	 *
	 * @param value
	 * @return
	 */
