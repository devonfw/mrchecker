node(){
	...
	properties([
		parameters([
			string(defaultValue: 'allure-framework-modules/allure-security-module/', description: 'Execute job for given Module. Example allure-framework-modules/allure-security-module/ ', name: 'APP_WORKSPACE'),
