node(){
	...
	properties([
		parameters([
			string(defaultValue: 'allure-framework-modules/', description: 'Execute job for given Module. Example allure-framework-modules/allure-core-module/ ', name: 'APP_WORKSPACE'),
