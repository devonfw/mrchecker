...
import com.example.selenium.core.exceptions.BFRobotInitilizationException;
import com.example.selenium.core.exceptions.BFWaittingForBrowserWindowsException;
...
public class WindowUtils {
	...
	public static void closeAllWindowsExcept(String url) {
		...
		if (desiredWindowHandle != null) {
			...
			throw new BFComponentStateException(
					WindowUtils.class.getSimpleName(),
					"closeAllWindowsExcept " + url,
	...
	public static Set<String> waitForOpeningSecondBrowserWindow(String timeoutDescription) throws InterruptedException {
		...
		Set<String> allBrowserWindows = BasePage.getDriver().getWindowHandles();
