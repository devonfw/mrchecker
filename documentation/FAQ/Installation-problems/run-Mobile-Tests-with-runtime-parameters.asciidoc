...
----
 ...
 ----
  but it doesn’t work because missing POM file .Then I tried from:
  ----
...
If I check the repository online http://repo1.maven.org/maven2 and I go  in http://repo1.maven.org/maven2/com/capgemini/mrchecker/ -  didn’t dinf anything about
