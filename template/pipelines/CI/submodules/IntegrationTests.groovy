...
//# Unit test run
	stage('Integration test'){
        sh"""
            ...
            mvn -q surefire:test -Dtest=${env.TEST_NAME} -Dthread.count=${env.THREAD_COUNT} -DseleniumGrid=${env.SELENIUM_HUBURL} -Denv=${env.ENVIRONMENT} -DbrowserOptions=${env.SELENIUM_BROWSER_OPTIONS} -Dbrowser=${env.SELENIUM_BROWSER} ${env.MVN_PARAMETERS}
